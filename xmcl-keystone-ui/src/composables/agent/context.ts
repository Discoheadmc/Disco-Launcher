...
export function resolveAgentSessionSystemPrompt(stored: string | undefined, generated: string, compacted: boolean) {
  const renamedVfsShell = stored?.includes('The `bash` tool is a virtual DHMC command runner') && generated.includes('The `vfs_shell` tool is a virtual DHMC command runner')
